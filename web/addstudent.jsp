<%-- 
    Document   : addstudent
    Created on : 26-Sep-2021, 12:51:13 AM
    Author     : utsav
--%>
	...
	<h4 style="color:<%= color %>"><%= msg %></h4>
        ...
        <form id="form" method="post" action="addstudent.jsp" class="form-horizontal">
			...
			<div class="form-group">
  			...
  			<input type="text" name="sname" class="form-control" id="tname">
                  </div>
			</div>
			<div class="form-group">
                 <div  class="col-sm-4"></div>
            ...
            <div class="form-group" align="right">
                ...
                <div class="col-sm-6">
                    <div class="col-sm-2">
                        <Button class="btn btn-warning" style="width: 80px;">Submit</Button>
                    </div>
                    <div class="col-sm-4">
                    </div>
        ...
        <div class="col-sm-12"  align="right">
            <a href="index.jsp"><Button class="btn btn-warning" style="width: 80px;">Home</Button></a>
        </div>
    </body>
</html>